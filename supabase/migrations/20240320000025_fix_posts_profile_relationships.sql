-- Fix posts profile relationships
-- This migration ensures all posts tables properly reference the profiles table
...
-- Recreate posts table with correct relationships
